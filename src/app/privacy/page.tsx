export default function LegalPage() {
  ...
  return (
    ...
    <main className="min-h-screen bg-foreground text-background/80 py-32 px-6 text-left">
      <div className="max-w-4xl mx-auto">
        ...
        <div 
          className="
            ...
            leading-relaxed
            space-y-6
            /* Styling English HTML tags */
            [&_h2]:text-white [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:font-['Acumin']
            [&_p]:text-background/70 [&_p]:text-lg
            [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mb-2 /* Changed pr-6 (Arabic) to pl-6 (English) */
          "
      ...
      <div className="mt-20">
        <a href="/" className="font-arabic-stylized text-secondary hover:underline">
            ← GO BACK TO HOME
        </a>
        </div>
    </main>
